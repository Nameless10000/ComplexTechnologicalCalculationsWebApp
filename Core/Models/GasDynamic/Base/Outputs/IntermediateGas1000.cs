...
public class IntermediateGas1000 : Entity
{
    ...
    [DisplayName("Объём Vсо при t=1000")] public double Volume_CO_1000 { get; set; }

    [DisplayName("Объём Н2 при t=1000")] public double Volume_H2_1000 { get; set; }

    [DisplayName("Объём N2 при t=1000")] public double Volume_N2_1000 { get; set; }
