...
public class HydrodynamicsLower : Entity
{
    ...
    [DisplayName(
        "Коэффициент пропорциональности между минутным расходом дутья и скоростью фильтрации газа в нижней зоне печи")]
    public double Koef_Proporc_Dut_Filtr_Niz { get; set; }

    [DisplayName("Коэффициент АН")] public double Koef_An { get; set; }
}