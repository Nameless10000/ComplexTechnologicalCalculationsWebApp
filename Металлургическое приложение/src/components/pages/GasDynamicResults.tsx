...
export function GasDynamicResults({ results }: GasDynamicResultsProps) {
  ...
  if (!results || !results.blastFurnance) {
    return (
      <Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-1">
              <ResultRow
                ...
                value={data.blastFurnance.carbonBalance.c_Input}
                unit="кг"
              />
              <ResultRow
                label="Расход С на прямое восстановление оксидов Fe, Mn, Si, а также на десульфурацию"
                value={data.blastFurnance.carbonBalance.c_Out_Vosstan}
                unit="кг"
              />
              <ResultRow
                label="Растворяется углерода в чугуну"
                value={data.blastFurnance.carbonBalance.c_Out_Chugun}
                unit="кг"
              />
              <ResultRow
                label="Расход С на образование метана"
                value={data.blastFurnance.carbonBalance.c_Out_Metan}
                unit="кг"
              />
              <ResultRow
                label="Количество С сгорающего у фурм"
                value={data.blastFurnance.carbonBalance.c_Out_Furm}
                unit="кг"
              />
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-1">
              <ResultRow
                ...
                value={data.blastFurnance.materialConsumption.udeln_Aglo}
                unit="т/т чугуна"
              />
              <ResultRow
                label="Удельный расход окатышей"
                value={data.blastFurnance.materialConsumption.udeln_Okat}
                unit="т/т чугуна"
              />
              <ResultRow
                label="Удельный расход известняка"
                value={data.blastFurnance.materialConsumption.udeln_Izvest}
                unit="кг/т чугуна"
              />
              <ResultRow
                label="Удельный расход кокса, выраженный в т/т чугуна"
                value={data.blastFurnance.materialConsumption.udeln_Koks_1000}
                unit="т/т чугуна"
              />
              <ResultRow
                label="Масса шихты на 1 тонну чугуна"
                value={data.blastFurnance.materialConsumption.udeln_Sum}
                unit="т/т чугуна"
              />
              <ResultRow
                label="Расход природного газа в расчёте на 1кг кокса"
                value={data.blastFurnance.materialConsumption.rashod_Prir_Gaz}
                unit="м³/кг"
              />
            </CardContent>
          </Card>
            ...
            <CardContent className="grid gap-4 md:grid-cols-2">
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.chargeAndPacking.volume_Aglo_1chugun}
                  unit="м³"
                />
                <ResultRow
                  label="Объём окатышей на 1т чугуна"
                  value={data.blastFurnance.chargeAndPacking.volume_Okat_1chugun}
                  unit="м³"
                />
                <ResultRow
                  label="Объём кокса на 1т чугуна"
                  value={data.blastFurnance.chargeAndPacking.volume_Koks_1chugun}
                  unit="м³"
                />
                <ResultRow
                  label="Суммарный объём шихты"
                  value={data.blastFurnance.chargeAndPacking.volume_Sum_1chugun}
                  unit="м³"
                />
              </div>
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.chargeAndPacking.shihta_Dolya_Aglo}
                  precision={3}
                />
                <ResultRow
                  label="Объёмная доля окатышей"
                  value={data.blastFurnance.chargeAndPacking.shihta_Dolya_Okat}
                  precision={3}
                />
                <ResultRow
                  label="Объёмная доля кокса"
                  value={data.blastFurnance.chargeAndPacking.shihta_Dolya_Koks}
                  precision={3}
                />
                <ResultRow
                  label="Насыпная масса слоя шихты"
                  value={data.blastFurnance.chargeAndPacking.massa_Nasyp_Shihta}
                  unit="кг/м³"
                />
              </div>
            </CardContent>
            ...
            <CardContent className="grid gap-4 md:grid-cols-2">
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.chargeAndPacking.shihta_Porozn_Verh}
                  precision={3}
                />
                <ResultRow
                  label="Эквивалентный диаметр куска шихты в верхней зоне"
                  value={data.blastFurnance.chargeAndPacking.shihta_Diam_Verh}
                  unit="мм"
                />
                <ResultRow
                  label="Эквивалентный диаметр кусков кокса"
                  value={data.blastFurnance.chargeAndPacking.diam_Koks}
                  unit="мм"
                />
                <ResultRow
                  label="Порозность слоя кокса"
                  value={data.blastFurnance.chargeAndPacking.porozn_Koks}
                  precision={3}
                />
              </div>
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.chargeAndPacking.volume_Udeln_Shlak}
                  unit="м³"
                />
                <ResultRow
                  label="Скорректированная порозность слоя"
                  value={data.blastFurnance.chargeAndPacking.porozn_Sloy_Korrekt}
                  precision={3}
                />
                <ResultRow
                  label="Эквивалентный диаметр куска агломерата"
                  value={data.blastFurnance.chargeAndPacking.diam_Aglo}
                  unit="мм"
                />
                <ResultRow
                  label="Порозность слоя агломерата"
                  value={data.blastFurnance.chargeAndPacking.porozn_Aglo}
                  precision={3}
                />
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-1">
              <ResultRow
                ...
                value={data.blastFurnance.furnaceGeometry.s_Sech_Niz}
                unit="м²"
              />
              <ResultRow
                label="Средний диаметр нижней части доменной печи"
                value={data.blastFurnance.furnaceGeometry.diam_Niz}
                unit="м"
              />
              <ResultRow
                label="Средний диаметр верхней части печи"
                value={data.blastFurnance.furnaceGeometry.diam_Verh}
                unit="м"
              />
              <ResultRow
                label="Высота слоя шихты в нижней зоне печи"
                value={data.blastFurnance.furnaceGeometry.height_Shihta_Niz}
                unit="м"
              />
              <ResultRow
                label="Высота слоя шихты в верхней зоне печи"
                value={data.blastFurnance.furnaceGeometry.shihta_Height_Verh}
                unit="м"
              />
              <ResultRow
                label="Активная высота слоя шихты продуваемая газами"
                value={data.blastFurnance.furnaceGeometry.height_Aktiv}
                unit="м"
              />
            </CardContent>
          </Card>
            ...
            <CardContent className="grid gap-4 md:grid-cols-2">
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.hearthGas.furmgaz_Koks}
                  unit="м³/кг"
                />
                <ResultRow
                  label="Выход фурменного газа при конверсии 1м³ природного газа"
                  value={data.blastFurnance.hearthGas.furmgaz_Prir_Gaz}
                  unit="м³/м³"
                />
                <ResultRow
                  label="Суммарный выход фурменного газа"
                  value={data.blastFurnance.hearthGas.furmgaz_Sum}
                  unit="м³"
                />
                <ResultRow
                  label="Удельный выход фурменного (горнового) газа"
                  value={data.blastFurnance.hearthGas.furmgaz_Udeln}
                  unit="м³/т"
                />
              </div>
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.hearthGas.furmgaz_CO}
                  unit="м³"
                />
                <ResultRow
                  label="Содержание H₂ в горновом газе"
                  value={data.blastFurnance.hearthGas.furmgaz_H2}
                  unit="м³"
                />
                <ResultRow
                  label="Содержание N₂ в горновом газе"
                  value={data.blastFurnance.hearthGas.furmgaz_N2}
                  unit="м³"
                />
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-1">
              <ResultRow
                ...
                value={data.blastFurnance.hearthGas.teplosod_Furmgaz}
                unit="кДж/м³"
              />
              <ResultRow
                label="Теоретическая температура горения"
                value={data.blastFurnance.hearthGas.temp_Teor}
                unit="°C"
              />
              <ResultRow
                label="Средняя температура газов в нижней зоне печи"
                value={data.blastFurnance.hearthGas.temp_Sredn_Niz}
                unit="°C"
              />
            </CardContent>
          </Card>
            ...
            <CardContent className="grid gap-4 md:grid-cols-2">
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.intermediateGas1000.volume_CO_Pvost}
                  unit="м³"
                />
                <ResultRow
                  label="Объём CO при t=1000°C"
                  value={data.blastFurnance.intermediateGas1000.volume_CO_1000}
                  unit="м³"
                />
                <ResultRow
                  label="Объём H₂ при t=1000°C"
                  value={data.blastFurnance.intermediateGas1000.volume_H2_1000}
                  unit="м³"
                />
                <ResultRow
                  label="Объём N₂ при t=1000°C"
                  value={data.blastFurnance.intermediateGas1000.volume_N2_1000}
                  unit="м³"
                />
                <ResultRow
                  label="Суммарный объём при t=1000°C"
                  value={data.blastFurnance.intermediateGas1000.volume_Sum_1000}
                  unit="м³"
                />
              </div>
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.intermediateGas1000.domengaz_CO_1000 * 100}
                  unit="%"
                />
                <ResultRow
                  label="Состав газа H₂ на горизонте t=1000°C"
                  value={data.blastFurnance.intermediateGas1000.domengaz_H2_1000 * 100}
                  unit="%"
                />
                <ResultRow
                  label="Состав газа N₂ на горизонте t=1000°C"
                  value={data.blastFurnance.intermediateGas1000.domengaz_N2_1000 * 100}
                  unit="%"
                />
                <ResultRow
                  label="Плотность газа на горизонте 1000°C при н.у."
                  value={data.blastFurnance.intermediateGas1000.domengaz_Plotn_1000}
                  unit="кг/м³"
                />
                <ResultRow
                  label="Секундный расход доменного газа на горизонте 1000°C"
                  value={data.blastFurnance.intermediateGas1000.domengaz_Rashod_1000}
                  unit="кг/с"
                />
              </div>
            </CardContent>
            ...
            <CardContent className="grid gap-4 md:grid-cols-2">
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.topGas.volume_CO2_Izvest}
                  unit="м³"
                />
                <ResultRow
                  label="Объём CO₂ при косвенном восстановлении"
                  value={data.blastFurnance.topGas.volume_CO2_Kvost}
                  unit="м³"
                />
                <ResultRow
                  label="Объём CO₂ в колошниковом газе"
                  value={data.blastFurnance.topGas.volume_CO2_Kolgaz}
                  unit="м³"
                />
                <ResultRow
                  label="Объём CO в колошниковом газе"
                  value={data.blastFurnance.topGas.volume_CO_Kolgaz}
                  unit="м³"
                />
                <ResultRow
                  label="Объём CH₄ в колошниковом газе"
                  value={data.blastFurnance.topGas.volume_CH4_Kolgaz}
                  unit="м³"
                />
                <ResultRow
                  label="Объём N₂ в колошниковом газе"
                  value={data.blastFurnance.topGas.volume_N2_Kolgaz}
                  unit="м³"
                />
                <ResultRow
                  label="Объём H₂ в колошниковом газе"
                  value={data.blastFurnance.topGas.volume_H2_Kolgaz}
                  unit="м³"
                />
              </div>
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.topGas.udeln_Kolgaz}
                  unit="м³/т"
                />
                <ResultRow
                  label="Расчётный состав: CO₂"
                  value={data.blastFurnance.topGas.kolgaz_CO2}
                  unit="%"
                />
                <ResultRow
                  label="Расчётный состав: CO"
                  value={data.blastFurnance.topGas.kolgaz_CO}
                  unit="%"
                />
                <ResultRow
                  label="Расчётный состав: H₂"
                  value={data.blastFurnance.topGas.kolgaz_H2}
                  unit="%"
                />
                <ResultRow
                  label="Расчётный состав: CH₄"
                  value={data.blastFurnance.topGas.kolgaz_CH4}
                  unit="%"
                />
                <ResultRow
                  label="Расчётный состав: N₂"
                  value={data.blastFurnance.topGas.kolgaz_N2}
                  unit="%"
                />
                <ResultRow
                  label="Плотность колошникового газа при н.у."
                  value={data.blastFurnance.topGas.kolgaz_Plotn}
                  unit="кг/м³"
                />
                <ResultRow
                  label="Секундный выход колошникового газа"
                  value={data.blastFurnance.topGas.kolgaz_Minut}
                  unit="кг/с"
                />
              </div>
            </CardContent>
            ...
            <CardContent className="grid gap-4 md:grid-cols-2">
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.hydrodynamicsLower.speed_Filtr_Niz}
                  unit="м/с"
                />
                <ResultRow
                  label="Значение коэффициента трения"
                  value={data.blastFurnance.hydrodynamicsLower.tren_Koef}
                  precision={0}
                />
                <ResultRow
                  label="Значение коэффициента трения с учетом потерь на тракте"
                  value={data.blastFurnance.hydrodynamicsLower.tren_Sum}
                  precision={0}
                />
                <ResultRow
                  label="Потери напора дутья на воздушных фурмах"
                  value={data.blastFurnance.hydrodynamicsLower.poteri_Furm}
                  unit="атм"
                />
                <ResultRow
                  label="Нижний перепад давления газов по высоте слоя шихты"
                  value={data.blastFurnance.hydrodynamicsLower.perepad_Niz_Itog}
                  unit="атм"
                />
              </div>
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.hydrodynamicsLower.perepad_Niz_Dolya}
                  precision={3}
                />
                <ResultRow
                  label="Избыточное давление газа на горизонте 1000°C"
                  value={data.blastFurnance.hydrodynamicsLower.davlen_Izb_1000}
                  unit="ати"
                />
                <ResultRow
                  label="Среднее значение абсолютного давления газа в нижней зоне"
                  value={data.blastFurnance.hydrodynamicsLower.davlen_Niz}
                  unit="атм"
                />
                <ResultRow
                  label="Коэффициент сопротивления"
                  value={data.blastFurnance.hydrodynamicsLower.koef_Soprot_Niz}
                  precision={0}
                />
                <ResultRow
                  label="Коэффициент АН"
                  value={data.blastFurnance.hydrodynamicsLower.koef_An}
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="grid gap-4 md:grid-cols-2">
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.hydrodynamicsUpper.speed_Filtr_Verh}
                  unit="м/с"
                />
                <ResultRow
                  label="Скорость фильтрации через верхнюю часть горна при н.у."
                  value={data.blastFurnance.hydrodynamicsUpper.speed_Filtr_Gorn}
                  unit="м/с"
                />
                <ResultRow
                  label="Действительная скорость движения газа в верхней части горна"
                  value={data.blastFurnance.hydrodynamicsUpper.speed_Real_Verh}
                  unit="м/с"
                />
                <ResultRow
                  label="Скорость фильтрации в области распара"
                  value={data.blastFurnance.hydrodynamicsUpper.speed_Filtr_Raspar}
                  unit="м/с"
                />
                <ResultRow
                  label="Скорость движения газа в области распара"
                  value={data.blastFurnance.hydrodynamicsUpper.speed_Real_Raspar}
                  unit="м/с"
                />
                <ResultRow
                  label="Скорость фильтрации через колошник"
                  value={data.blastFurnance.hydrodynamicsUpper.speed_Filtr_Koloshnik}
                  unit="м/с"
                />
              </div>
              <div className="space-y-1">
                <ResultRow
                  ...
                  value={data.blastFurnance.hydrodynamicsUpper.speed_Real_Koloshnik}
                  unit="м/с"
                />
                <ResultRow
                  label="Абсолютное среднее давление в верхней зоне"
                  value={data.blastFurnance.hydrodynamicsUpper.davlen_Verh}
                  unit="атм"
                />
                <ResultRow
                  label="Коэффициент сопротивления слоя шихты"
                  value={data.blastFurnance.hydrodynamicsUpper.koef_Soprot_Verh}
                  precision={0}
                />
                <ResultRow
                  label="Коэффициент АВ"
                  value={data.blastFurnance.hydrodynamicsUpper.koef_Av}
                />
                <ResultRow
                  label="Перепад давления газов по высоте слоя шихты"
                  value={data.blastFurnance.hydrodynamicsUpper.perepad_Davlen}
                  unit="атм"
                />
                <ResultRow
                  label="Степень уравновешивания шихты"
                  value={data.blastFurnance.hydrodynamicsUpper.stepen_Urav}
                  unit="%"
                />
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-1">
              <ResultRow
                ...
                value={data.blastFurnance.thermalParameters.teploemk_2atom}
                unit="кДж/(кг·К)"
              />
              <ResultRow
                label="Теплоёмкость паров воды при температуре горячего дутья"
                value={data.blastFurnance.thermalParameters.teploemk_Voda}
                unit="кДж/(кг·К)"
              />
              <ResultRow
                label="Теплосодержание горячего дутья за вычетом теплоты разложения влаги дутья"
                value={data.blastFurnance.thermalParameters.teplosod_Dut}
                unit="кДж/м³"
              />
              <ResultRow
                label="Теплосодержание углерода кокса, пришедшего к фурмам"
                value={data.blastFurnance.thermalParameters.teplosod_Koks}
                unit="кДж/кг"
              />
              <ResultRow
                label="Средняя температура в верхней зоне"
                value={data.blastFurnance.thermalParameters.temp_Verh}
                unit="°C"
              />
            </CardContent>
          </Card>
