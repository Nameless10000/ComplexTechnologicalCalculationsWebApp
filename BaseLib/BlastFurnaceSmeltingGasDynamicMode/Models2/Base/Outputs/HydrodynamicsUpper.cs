...
public class HydrodynamicsUpper
{
    ...
    [DisplayName("Скорость движения газа в области распара с учётом действительных параметров газа и с учётом порозности слоя")]
    ...
    [DisplayName("Скорость движения газа через колошник с учётом действительных параметров газа и с учётом порозности слоя")]
    ...
    [DisplayName("Коэффициент пропорциональности между минутным расходом дутья и скоростью фильтрации газа в верхней зоне печи")]
    public double Koef_Proporc_Dut_Filtr_Verh { get; set; }

    [DisplayName("Коэффициент АВ")]
    public double Koef_Av { get; set; }
